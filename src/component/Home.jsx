import youtube from "../assets/image/youtube_icon.png";
  ...
  return (
    <>
      <div className="grid grid-cols-1 grid-col   md:grid-cols-2 lg:grid-cols-2 mt-[3rem]">
        {/* left side  */}
        <div className="order-2 sm:order-none flex flex-col pl-14 sm:px-40 gap-4 mt-10 sm:mt-20 h-64 sm:h-auto md:h-auto">
          <div className="animate-this1 text-xl font-sans font-extrabold ">
            Nayem Here ! 👋
          </div>
          <div className="animate-this2 text-3xl sm:text-4xl font-sans font-extralight">
            Love to Learn New Technology.. <br /> Love to Code..😊
          </div>
          <div className="animate-this3 text-xl sm:text-2xl text-green-500 font-sans font-extrabold">
            Front End Web-Developer
          </div>
          <div className="animate-this5 flex gap-6 my-3 cursor-pointer">
            <div className="shadow-sm-light border h-12 w-12 flex justify-center items-center rounded-lg ">
              <a href="https://www.youtube.com/channel/UCEnteSXoLRM0h_mfcgJuhhw">
                <img src={youtube} alt="" className="w-8 color-change" />
              </a>
            </div>
            <div className="shadow-sm-light border h-12 w-12 flex justify-center items-center rounded-lg">
          ...
          <div className="animate-this6 flex gap-12">
            ...
            >
              {" "}
              <button className="text-white  font-sans h-12  w-28 bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg   px-5 py-2.5 text-center me-2 mb-2">
                Hire Me!
              </button>
            </Link>
            <div>
